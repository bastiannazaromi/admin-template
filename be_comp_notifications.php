    ...
    <div class="block">
        ...
        <div class="block-content">
            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8">
                    <button type="button" class="js-notify btn btn-alt-info push" data-type="info" data-icon="fa fa-fw fa-info-circle mr-1" data-message="Congrats! You've reached level 12!">
            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8">
                    <button type="button" class="js-notify btn btn-alt-success push" data-type="success" data-icon="fa fa-fw fa-check mr-1" data-message="App was updated successfully to 1.2 version">
                        <i class="fa fa-bell mr-1"></i> Launch Notification
                    </button>
                    <p class="font-w600 mb-0">
                        You can also trigger it with JS:
            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8">
                    <button type="button" class="js-notify btn btn-alt-warning push" data-type="warning" data-icon="fa fa-fw fa-exclamation-triangle mr-1" data-message="Please make a backup before updating!">
                        <i class="fa fa-bell mr-1"></i> Launch Notification
                    </button>
                    <p class="font-w600 mb-0">
                        You can also trigger it with JS:
            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8">
                    <button type="button" class="js-notify btn btn-alt-danger push" data-type="danger" data-icon="fa fa-fw fa-times mr-1" data-message="Update failed! :-(">
                        <i class="fa fa-bell mr-1"></i> Launch Notification
                    </button>
                    <p class="font-w600 mb-0">
                        You can also trigger it with JS:
