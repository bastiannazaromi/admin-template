                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-vcenter mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('content_toggle', '#my-block');">Toggle Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('content_hide', '#my-block');">Hide Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('content_show', '#my-block');">Show Content</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('state_toggle', '#my-block');">Toggle State</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('state_loading', '#my-block');">State Loading</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('state_normal', '#my-block');">State Normal</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('fullscreen_toggle', '#my-block');">Toggle Fullscreen</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('fullscreen_on', '#my-block');">Fullscreen On</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('fullscreen_off', '#my-block');">Fullscreen Off</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('pinned_toggle', '#my-block');">Toggle Pinned</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('pinned_on', '#my-block');">Pinned On</button>
                                    </td>
                                    <td>
                                        <code>pinned_on</code>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('pinned_off', '#my-block');">Pinned Off</button>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('close', '#my-block');">Close</button>
                                    </td>
                                    <td>
                                        <code>close</code>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-alt-primary btn-block" onclick="One.block('open', '#my-block');">Open</button>
                                    </td>
                                    <td>
                                        <code>open</code>
                                    </td>
        ...
        <div class="col-md-6">
            <div class="block block-rounded">
                <div class="block-header">
                    ...
                    <div class="block-options">
                        <!-- To close a block, just add the following properties to your button: data-toggle="block-option" data-action="close" -->
                        <button type="button" class="btn btn-sm btn-alt-primary" data-toggle="block-option" data-action="close"><i class="si si-close"></i></button>
                    </div>
                </div>
                <div class="block-content">
                    <?php $one->get_text('small'); ?>
