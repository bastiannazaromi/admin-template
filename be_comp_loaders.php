            ...
            <div class="table-responsive">
                <table class="table table-striped table-vcenter mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <button type="button" class="btn btn-alt-success mb-3" data-toggle="layout" data-action="header_loader_on">Start Header Loader</button>
        ...
        <div class="block-content block-content-full">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-alt-primary mb-3" onclick="One.loader('show');setTimeout(function(){One.loader('hide');},3000);">Preview Page Loader</button>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-striped table-vcenter mb-0">
