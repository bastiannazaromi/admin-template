                    ...
                    <li class="nav-item ml-auto">
                        <div class="btn-group btn-group-sm pr-2">
                            ...
                            <div class="btn-group btn-group-sm" role="group">
                                <button type="button" class="btn btn-alt-primary dropdown-toggle" id="btnGroupTabs1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    More
                                </button>
                ...
                <ul class="nav nav-tabs nav-tabs-block justify-content-end align-items-center" data-toggle="tabs" role="tablist">
                    <li class="nav-item mr-auto">
                        <div class="btn-group btn-group-sm pl-2">
                            <div class="btn-group btn-group-sm" role="group">
                                <button type="button" class="btn btn-alt-primary dropdown-toggle" id="btnGroupTabs2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    More
                                </button>
