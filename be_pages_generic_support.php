...
<div class="bg-body-dark">
    <div class="content content-full">
        <div class="my-5 text-center">
            ...
            <a class="btn btn-rounded btn-primary px-4 py-2 invisible" data-toggle="appear" data-class="animated bounceIn" href="be_pages_generic_contact.php">Contact Us</a>
        </div>
    </div>
</div>
<!-- END Contact Us -->
