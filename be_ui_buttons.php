    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2">
                Buttons <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted">Custom buttons styles to fulfill any design approach.</small>
            </h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    <li class="breadcrumb-item">Elements</li>
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href="">Buttons</a>
                    </li>
                </ol>
            </nav>
        </div>
...
<div class="content">
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            ...
            <button type="button" class="btn btn-lg btn-square btn-secondary mr-1 mb-3">
                <i class="fa fa-fw fa-wifi mr-1"></i> Wifi Available
            </button>
            <button type="button" class="btn btn-rounded btn-alt-danger mr-1 mb-3">
            ...
            <button type="button" class="btn btn-lg btn-outline-primary mr-1 mb-3">
                <i class="fab fa-fw fa-instagram mr-1"></i> Post your image
            </button>
            <button type="button" class="btn btn-rounded btn-success mr-1 mb-3">
                <i class="fa fa-fw fa-pencil-alt"></i>
            </button>
            <button type="button" class="btn btn-lg btn-secondary mr-1 mb-3">
                <i class="fab fa-fw fa-youtube mr-1"></i> YouTube
            </button>
            <button type="button" class="btn btn-sm btn-square btn-outline-warning mr-1 mb-3">
                <i class="far fa-fw fa-envelope mr-1"></i> Messages
            </button>
            <button type="button" class="btn btn-sm btn-dark mr-1 mb-3">
            ...
            <button type="button" class="btn btn-lg btn-alt-warning mr-1 mb-3">
                <i class="fab fa-fw fa-instagram mr-1"></i> Instagram
            </button>
            <button type="button" class="btn btn-sm btn-alt-primary mr-1 mb-3">
                <i class="fa fa-fw fa-rocket mr-1"></i> Test
            </button>
            <button type="button" class="btn btn-sm btn-rounded btn-outline-dark mr-1 mb-3">
            ...
            <button type="button" class="btn btn-lg btn-rounded btn-alt-success px-4 mr-1 mb-3">
                <i class="si si-rocket mr-1"></i> Launch Product
            </button>
            <button type="button" class="btn btn-sm btn-square btn-info mr-1 mb-3">
