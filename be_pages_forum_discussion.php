                ...
                <tbody>
                    <tr class="table-active">
                        ...
                        <td class="font-size-sm text-muted">
                            <a class="font-w600" href="be_pages_generic_profile.php"><?php $one->get_name('female'); ?></a> on <em>July 1, 2019 16:15</em>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a class="font-w600" href="be_pages_generic_profile.php"><?php $one->get_name('male'); ?></a> on <em>July 10, 2019 10:09</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a class="font-w600" href="be_pages_generic_profile.php"><?php $one->get_name('male'); ?></a> on <em>July 15, 2019 20:17</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
                    ...
                    <tr class="table-active">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a class="font-w600" href="be_pages_generic_profile.php"><?php $one->get_name('female'); ?></a> on <em>July 20, 2019 20:29</em>
                        </td>
                    </tr>
                    <tr>
                        <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
                    ...
                    <tr class="table-active" id="forum-reply-form">
                        <td class="d-none d-sm-table-cell"></td>
                        <td class="font-size-sm text-muted">
                            <a class="font-w600" href="be_pages_generic_profile.php"><?php $one->get_name('male'); ?></a> Just now
                        </td>
                    </tr>
                    <tr>
